...
class _CreateRecipientProfileScreenState
  ...
  Future<void> _handleSubmit() async {
    ...
    // Temporary delay to simulate saving.
    // This will later be replaced by backend/database code.
              ...
              children: [
                ...
                Text(
                  isEditing
                      ...
                      'Your new information has been saved.'
                      : 'Welcome aboard, '
                      '${_fullNameController.text.trim().isEmpty ? 'Neighbour' : _fullNameController.text.trim()}! '
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            widget.isEditing
                ? 'Update your information and dietary preferences '
                'to keep your NeighbourShare profile accurate.'
  ...
  Widget _buildTermsText() {
    return Text(
      widget.isEditing
          ? 'Make sure your recipient information is accurate and up to date.'
          : 'By creating a recipient profile, you agree to '
          'NeighbourShare\'s Terms of Service and Privacy Policy, '
